-- All Widgets Theme (Nordic)
-- Unified conky theme containing all widgets in a single instance
-- Nordic style: Nord color palette - deep navy panels, frost blue borders, snow white text

-- ###Style###
HTML_color = "#eceff4"
HTML_color_border = "#88c0d0"
HTML_bg_color = "#2e3440"
transparency_bg = 1.0
...
HTML_critical_kev = "#bf616a"
HTML_critical_infra = "#d08770"
...
-- Crypto extra colors
HTML_chart_line = "#88c0d0"
HTML_chart_fill = "#88c0d0"
HTML_change_up = "#a3be8c"
HTML_change_down = "#bf616a"
transparency_chart = 0.5
...
-- Weather colors
HTML_circle = "#81a1c1"
HTML_border_w = "#88c0d0"
HTML_text_w = "#eceff4"
transparency_w = 0.3
transparency_border_w = 0.9
...
-- Revisited colors
HTML_color_battery = "#a3be8c"
HTML_color_drive_1 = "#88c0d0"
HTML_color_drive_2 = "#b48ead"
HTML_background_CPU = "#d08770"
HTML_color_RAM = "#ebcb8b"
...
-- Calendar colors
HTML_colors_cal = "#81a1c1"
HTML_colors_current_cal = "#bf616a"
...
function draw_function(cr)
    ...
    if enabled_kev then
        ...
        draw_vuln_widget(cr, kx2, ky2, "KEV", os.getenv("HOME") .. "/.config/conky/all-widgets-nordic-conky-manager/fetch_vulns.py", r_crit_kev, g_crit_kev, b_crit_kev)
    end
    ...
    if enabled_infra then
        ...
        draw_vuln_widget(cr, ix, iy, "INFRA", os.getenv("HOME") .. "/.config/conky/all-widgets-nordic-conky-manager/fetch_infra_vulns.py", r_crit_infra, g_crit_infra, b_crit_infra)
    end
...
function conky_start_widgets()
    local function draw_conky_function(cr)
        ...
        if not ok then
            local f = io.open(os.getenv("HOME") .. "/.config/conky/all-widgets-nordic-conky-manager/error.log", "a")
            if f then
